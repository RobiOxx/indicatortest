	...
	private fun refreshOnPageChangedListener() {
		pager?.let {
			if (it.isNotEmpty) {
				...
				it.addOnPageChangeListener(onPageChangeListenerHelper)
				onPageChangeListenerHelper.onPageScrolled(it.currentItem, 0f)
			}
		}
	}
			...
			override fun addOnPageChangeListener(
				...
				onPageChangeListener = object : OnPageChangeListener {
					override fun onPageScrolled(
						...
						onPageChangeListenerHelper.onPageScrolled(position % count, positionOffset)
					}
